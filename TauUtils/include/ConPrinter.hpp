...
inline u32 Print(const Char* fmt, CurrArg currArg, Args... args) noexcept
{
    u32 count = 0;
    iSys blockBegin = 0;
            ...
            else if(fmt[i + 1] == Char { 'f' })
            {
                ...
                else
                {
                    ...
                    switch(fmt[i + 2])
                    {
                        ...
                        case '1': precision = 1; break;
                        case '2': precision = 2; break;
                        case '3': precision = 3; break;
                        case '4': precision = 4; break;
                        case '5': precision = 5; break;
                        case '6': precision = 6; break;
                        case '7': precision = 7; break;
                        case '8': precision = 8; break;
                        case '9': precision = 9; break;
...
inline u32 PrintLn(const Char* fmt, Args... args) noexcept
{
